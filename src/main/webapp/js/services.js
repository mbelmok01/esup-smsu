...
function computeRoutes(baseURL) {
  ...
  [{ route: '/welcome', mainText: "Accueil", controller: 'WelcomeCtrl' }, 
     ...
     { route: '/send-notification', mainText: "Envoi de Notification Push", show: 'loggedUser.can.FCTN_PUSH_ENVOI_GROUPES || loggedUser.can.FCTN_SMS_ENVOI_LOGIN', controller: 'SendNotificationCtrl'},
